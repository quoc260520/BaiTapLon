<?php
include_once '../Controller/C_quenpass.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="col-sm-6 col-md-4 col-xs-12 container-quen">
                <form method="POST" action="">
                    <h2>Quên Mật Khẩu</h2>
                        ...
                        <div class="note">
                            <p><i><b>Lưu ý:</b>vui lòng cung cấp số diện thoại đã đăng kí để nhận thông báo lấy lại mật khẩu <a href="./V_index.php">Đăng Nhập</a>.</i></p>
                        </div>
