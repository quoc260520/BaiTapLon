...
if(isset($_POST["submit"]))
{
  ...
  if(isset($tentv) && isset($email) && isset($pass) && isset($sodienthoai))
  {
    ...
    if($rows>0)
    {
      echo '<center class="alert alert-danger">Tài khoản hoặc số điện thoại này đã tồn tại.Vui lòng đăng kí tài khoản khác!!!<a href="./index.php"> <b><i>Quay Lại</i></b></a> </center>"';
    }
    else
    {
      $sql="insert into thanhvien(TenTv,SoDienThoai,Email,Pass) values ('$tentv','$sodienthoai','$email','$pass')";
      $thuchien=mysqli_query($conn,$sql);
      echo '<center class="alert alert-success"> Đăng kí thành công. Đăng nhập<a href="./index.php"> <b><i>tại đây</i></b></a> </center>"';
    }
  }
}
?>
