...
<?php
include_once '../Controller/C_danhmucsp.php';
?>
      <div class="MRight">
        <div class="navM">
          <div class="navMLeft">
            <a href="V_quantri.php?Page_layout=themsp"><button type="button" class="btn btn-primary"><i class="icon1 fa fa-plus" aria-hidden="true"></i>Thêm Sản Phẩm</button></a>
          </div>
          <div class="navMRight">
        ...
        <div class="menuM"></div>
          <table class="tb" style="width:100%">
            ...
            <tr>
              ...
              <td style="text-align: center;"><a href="V_quantri.php?Page_layout=suasp&IdSp=<?php echo $row["IdSp"]?>"><i class="fa fa-wrench" aria-hidden="true"></i></a></td>
              <td style="text-align: center;"><a onclick="return XoaSP();" href="V_xoasp.php?IdSp=<?php echo $row["IdSp"]?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
            </tr>
            <?php } ?>
          </table>
      </div>